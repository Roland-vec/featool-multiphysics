...
%
%   [ GRID ] = RECTGRID( N_CX, N_CY, XP ) Generates a tensor product quadrilateral
%   grid with N_CX, N_CY cells in the x and y-directions, respectively. The
%   optional argument XP=[x1 y1 x2 y2] specifies the coordinates of the lower
%   left (x1,y1) and upper right (x2,y2) corners. A call without input arguments
