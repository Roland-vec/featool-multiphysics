...
% -------------------
% 
% The _FEATool Multiphysics_ simulation toolbox is developed in the
...
% ("we", "us", "ours"), a duly registered company whose registered
% place of business is 2003, 20/F, Tower 5, China Hong Kong City, 33
% Canton Road, Tsim Sha Tsui, Kowloon, Hong Kong. This Agreement sets
% the terms, rights, restrictions and obligations on using FEATool
% ("Software", "Program(s)") and documentation ("Documentation") created
...
% 
% b. KMG2D (3-Clause BSD License), Copyright 2009, J. Koko, ISIMA.
% 
% c. OpenFOAM (GPL License). OpenFOAM is distributed by the OpenFOAM
